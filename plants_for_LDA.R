...
# 
# dat = read.csv(text=RCurl::getURL("https://raw.githubusercontent.com/weecology/PortalData/master/Plants/Portal_plant_quadrats.csv"),
#                stringsAsFactors = FALSE)
# plant_list = read.csv(text=RCurl::getURL("https://raw.githubusercontent.com/weecology/PortalData/master/Plants/Portal_plant_species.csv"),
#                       stringsAsFactors = FALSE)
# 
# # filter out unknown species
# perennial = filter(plant_list,duration=='Perennial',commonname!='Unknown',community!='Shrub',community!='Perennial Shrub')
...
summer_table = read.csv('summerannuals.csv')
winter_table = read.csv('winterannuals.csv')
...
dates = c(1989:2009,2011:2018)
dates = winter_table$year
...
dates = c(1981:2002,2004:2008,2011,2014:2017)
