...
#' 
#' @example
#' a_table = ant_colony_table(c(1,2,5,6,7,9,11,14,15,16,18,21,22))
#'
ant_colony_table = function(selected_plots=1:24) {
  ...
  # not censused
  A = filter(ants, plot %in% selected_plots) %>% select(year,plot,species,colonies,flag)
